...
const platformSource = await readFile(webFixturePath('assets/js/platform-services.js'), 'utf8');
const androidSource = await readFile(webFixturePath('assets/js/rphub-android-adapter.js'), 'utf8');
