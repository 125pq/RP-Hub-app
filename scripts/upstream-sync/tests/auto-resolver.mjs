...
assert.equal(currentApp, patchChatExport(patchTextMetrics(patchAppNavigation(normalize(reviewedMergedApp193)))), 'current app matches the reviewed 1.9.3 merge replay');
